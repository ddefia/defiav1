...
import { loadBrandProfiles, saveBrandProfiles, BrandName, loadCalendarEvents, saveCalendarEvents } from './services/storage';
                ...
                <div className="flex-1 overflow-y-auto p-6 custom-scrollbar bg-gray-50/50">
                    ...
                    {(activeTab === 'writer' || activeTab === 'generate') && (
                        <div className="space-y-6 animate-fadeIn">
                            ...
                            {!generatedDraft && generatedImages.length === 0 && campaignStep === 1 && activeTab !== 'calendar' && (
