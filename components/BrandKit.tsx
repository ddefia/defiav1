      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-2">
          {config.referenceImages.map(img => (
            <div key={img.id} className="relative aspect-square rounded bg-gray-100 cursor-pointer overflow-hidden border border-brand-border group shadow-sm" onClick={() => setViewingImage(img.data)}>
