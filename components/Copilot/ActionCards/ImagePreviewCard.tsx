        ...
        return (
            <div className="p-4 bg-white border border-gray-200 rounded-xl animate-fadeIn duration-300 relative group shadow-sm">
                ...
                <div className="flex gap-2">
                    <Button className="flex-1" onClick={() => onNavigate('image-editor', { image: imageUrl, prompt: params?.imagePrompt })}>Edit High-Res</Button>
                    <Button
                        variant="secondary"
                        title="Draft Tweet for this image"
                        onClick={() => onNavigate('studio', { draft: params?.imagePrompt || "New Visual" })}
                    >
